...
FILE *LogfileID = fopen("svmnral.log", "w");
svm_parameter svm_param;
nral_parameter nral_param;
...
int get_second_order_mvp_for_i1(double *Xi, int i_up,
		vector<pair<double, int>> &Ilow, vector<int> &wss_list, double *minusF, double *y);
...
void wss_type_0(svm_problem *nral_prob, double *alpha, double *y_s,
		double *alpha_s, double *minusF, double *H_B_BN, double *G_BN);
void wss_type_1(svm_problem *nral_prob, double *alpha, double *y_s,
		double *alpha_s, double *minusF, double *H_B_BN, double *G_BN);
...
bool calcGradStopInnerLoop(svm_problem *nral_prob, double *HBN, double *G_BN,
		double *gradfg, double *y_s, double *alpha_fpgm, double lambda);
double getK_ij(svm_problem *nral_prob, double *Xi, int j);
void getK_i(svm_problem *nral_prob, double *H_i, int i);
void getQ_i(svm_problem *nral_prob, double *H_i, int i);
void readin_Data(const char *file_name, dataset *load_data, bool file_gamma,
		bool isTraining);
void get_gap(svm_problem *nral_prob, double *minusF);
