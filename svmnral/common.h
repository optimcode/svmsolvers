...
struct nral_parameter {
	...
	double mu_max = 10000;
	double mu_min = 1;
	double mu_incr = 1.05f;
	double mu_decr = 0.95f;
	...
	int maxinneriter = 250;
	int maxouteriter = 50;

	double alpha_delta_threshold = 1e-5f;
	double alpha_norm_diff_nral = 1e-6f;
	double alpha_norm_diff_newton = 1e-7f;
	double accuracy = 1e-3f;
	double nral_accuracy = 1e-5f;
	int max_pairs;
	int maxWSS;
	double reqAccuracy = DBL_MAX;
	double reqAccuracyFactor = 0.1;
